# Shopping List Pytest Starter Kit

Starter kit for writing tests for the shopping list example.

This version contains the completed source code for the shopping list example,
but without any tests. You can use it to write both doctests and regular pytest
tests.
...
```shell script
pip install dist/shopping_list_pytest_sk-0.0.2-py3-none-any.whl
```
